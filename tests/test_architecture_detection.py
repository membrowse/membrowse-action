...
class TestELFArchitectureDetection(unittest.TestCase):
    ...
    def test_esp32_elf_detection(self):
        ...
        esp32_elf = '/home/michael/projs/membudget/micropython/build_logs/4c55b0879b38b373b44e84552d6754b7842b5b72/esp32/firmware.elf'
    ...
    def test_arm_elf_detection(self):
        ...
        arm_elf = '/home/michael/projs/membudget/micropython/ports/bare-arm/build/firmware.elf'
    ...
    def test_parse_linker_scripts_with_elf(self):
        ...
        if os.path.exists(arm_elf):
            ...
            self.assertEqual(regions['FLASH']['total_size'], 0x100000)
            self.assertEqual(regions['RAM']['total_size'], 0x20000)
        else:
            self.skipTest("ARM ELF file not available")
