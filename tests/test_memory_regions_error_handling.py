...
class TestInvalidAddressFormats(TestMalformedLinkerScripts):
    ...
    def test_invalid_hex_addresses(self):
        ...
        if regions:
            ...
            self.assertEqual(regions["FLASH3"]["start_address"], 20480)  # 0x5000
    ...
    def test_invalid_size_formats(self):
        ...
        if regions:
            ...
            self.assertEqual(regions["FLASH3"]["total_size"], -524288)
...
class TestCorruptedMemoryBlocks(TestMalformedLinkerScripts):
    ...
    def test_multiple_memory_blocks_conflicting(self):
        ...
        if 'FLASH' in regions:
            ...
            self.assertIn(regions['FLASH']['start_address'], [0x08000000, 0x10000000])
...
class TestEdgeCasesAndBoundaryConditions(TestMalformedLinkerScripts):
    ...
    def test_zero_sized_regions(self):
        ...
        for region in regions.values():
            self.assertEqual(region['total_size'], 0)
    ...
    def test_very_long_content(self):
        ...
        regions_content = []
        for i in range(100):
            regions_content.append(f"REGION_{i:03d} (rw) : ORIGIN = 0x{0x20000000 + i*0x1000:08x}, LENGTH = 4K")
