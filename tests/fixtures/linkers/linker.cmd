MEMORY
    {
    RAM (wx) : ORIGIN = ((0) + 0x100000), LENGTH = ((2147483648) - 0x100000)
 ...
 *(.text.*)
 ...
 irq_alloc_area : { _irq_alloc_list_start = .; KEEP(*(SORT_BY_NAME(._irq_alloc.static.*))); _irq_alloc_list_end = .;; } > RAM
 device_deps :
 {
__device_deps_start = .;
...
stepper_drv_driver_api_area : { _stepper_drv_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._stepper_drv_driver_api.static.*))); _stepper_drv_driver_api_list_end = .;; } > RAM
 ...
 *(.data.*)
 ...
 pcie_dev_area : { _pcie_dev_list_start = .; KEEP(*(SORT_BY_NAME(._pcie_dev.static.*))); _pcie_dev_list_end = .;; } > RAM
    pagetables :
    {
    . = ALIGN(4096);
 ...
 __kernel_ram_end = ((0) + 0x100000) + ((2147483648) - 0x100000);
