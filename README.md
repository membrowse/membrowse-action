...
You can customize the PR comment content using a Jinja2 template file. The MemBrowse header (logo and title) is always included automatically - your template controls the content below it.
...
Create your template file (e.g., `.github/membrowse-comment.j2`):
...
| `marker` | str | HTML comment marker for identifying MemBrowse comments |
